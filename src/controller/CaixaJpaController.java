...
public class CaixaJpaController implements Serializable {
    ...
    private List<Caixa> caixaLista;

    public List<Caixa> getCaixaLista() {
        return caixaLista;
    }

    public void setCaixaLista(List<Caixa> caixaLista) {
        this.caixaLista = caixaLista;
    }

    public CaixaJpaController() {
        this.emf = Persistence.createEntityManagerFactory("ProjetoFinalPU");
        this.caixaLista = ObservableCollections.observableList(new ArrayList<Caixa>());
        this.limparLista();
    }

    public void limparLista() {
        this.caixaLista.clear();
        this.caixaLista.addAll(this.findCaixaEntities());
    }
